...
################################################################################################
Particle="Dplus" # # whether it is Dplus, D0, Ds, LctopK0s or LctopKpi analysis
Cent="kpPb5TeVFD" # used also to asses prompt or non-prompt and system

cfgFileData="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/3_ApplySelections/config_Dplus_pPb5Tev_data_tree.yml"
cfgFileMC="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/3_ApplySelections/config_Dplus_pPb5Tev_MC_tree.yml"
cfgFileFit="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/4_Analysis/1_RawYieldExtraction/config_Dplus_Fit_pPb5TeV.yml"
...
accFileName="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/2_ML/3_WorkingPointOptimization/Acceptance_Toy_DplusKpipi_yfidPtDep_etaDau09_ptDau100_FONLL5ptshape_FONLLy.root"
...
DataDrivenFractionFileName="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/4_Analysis/3_YieldFraction/wptweights_cent/cutvar_output.root"

#assuming cutsets config files starting with "cutset" and are .yml

CutSetsDir="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/5_Systematics/2_MLSelectionEfficiency/cutsets/"
declare -a CutSets=()
...
OutDirRawyields="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/5_Systematics/2_MLSelectionEfficiency/rawyields"
OutDirEfficiency="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/5_Systematics/2_MLSelectionEfficiency/efficiencies"
OutDirCrossSec="/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/5_Systematics/2_MLSelectionEfficiency/cross_sections"
OutDirRaa=""
################################################################################################
...
[ ${Cent} != "kpp13TeVPrompt" ] && [ ${Cent} != "kpp13TeVFD" ] &&
[ ${Cent} != "kpPb5TeVPrompt" ] && [ ${Cent} != "kpPb5TeVFD" ]; then
...
if [ ${Cent} == "kpp5TeVFD" ]; then
  ...
  isPrompt=false
  System=pp
elif [ ${Cent} == "kpPb5TeVPrompt" ]; then
  isPrompt=true
  System=pPb
elif [ ${Cent} == "kpPb5TeVFD" ]; then
  isPrompt=false
  System=pPb
else
  echo $(tput setaf 1) ERROR: system ${Cent} is not supported! $(tput sgr0)
...
if $DoDataRawYields; then
  ...
  do
    ...
    if [ ${Particle} != "D0" ]; then
      ...
      # python3 GetRawYieldsDplusDs.py /home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/4_Analysis/1_RawYieldExtraction/config_Dplus_Fit_pPb5TeV.yml 'kpPb5TeVPrompt' /home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/3_ApplySelections/invMass_Dplus_prompt_enhanced.root /home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/4_Analysis/1_RawYieldExtraction/test.root
      # python3 GetRawYieldsDplusDs.py ${cfgFileFit} 'kpPb5TeVPrompt' ${OutDirRawyields}/Distr_${Particle}_data${CutSets[$iCutSet]}.root ${OutDirRawyields}/RawYields${Particle}${CutSets[$iCutSet]}.root
    else
