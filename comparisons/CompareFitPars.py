...
def comp_fit_pars(do_ratio=False, meson='Dplus'): #pylint: disable-msg=too-many-statements,too-many-locals
    inputdir = '/home/abigot/AnalysisNonPromptDplus/Run2pPb5Tev/4_Analysis/1_RawYieldExtraction'
    input_files = ['raw_yield_prompt_enhanced.root', 'raw_yield_nonprompt_enhanced.root'] # ['RawYieldsDplus_pp5TeV_prompt_central.root', 'RawYieldsDplus_pp5TeV_FD_central_freesigma.root']
    input_files_MC = ['raw_yield_MC_prompt_enhanced.root', 'raw_yield_MC_nonprompt_enhanced.root'] # ['RawYieldsDplusMC_pp5TeV_prompt_central.root', 'RawYieldsDplusMC_pp5TeV_FD_central.root']
    
    ### MY MODIFS ###
    input_files_free_sigma = ['raw_yield_prompt_enhanced.root', 'raw_yield_nonprompt_enhanced_free_sigma.root']
    input_files_MC_free_sigma = ['raw_yield_MC_prompt_enhanced.root', 'raw_yield_MC_nonprompt_enhanced_free_sigma.root'] 
    ###
    ...
    input_files_free_sigma = input_files_MC_free_sigma + input_files_free_sigma
    ...
    for file_path, color, marker, legend_name in zip(input_files_free_sigma, colors, markers, legendnames):
        input_file = TFile(f'{inputdir}/{file_path}')
...
def main():
    ...
    parser.add_argument("--Dspecie", help="Dplus or Ds mesons", metavar="text", default="Dplus")
