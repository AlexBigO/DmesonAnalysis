...
inputfilenames = ['RpPb_np_D0_5TeV.root', 'RpPb_nonprompt_Dplus.root'] # ['HEPData_RpPbDplus_prompt.root', 'RpPb_nonprompt_Dplus.root']
histonames = ['RpPbFDD0', 'hRpPb'] # ['hRaa', 'hRpPb']
graphnames = ['SystwoNorm', 'gRaaSystTot'] # ['gRaaSystTot', 'gRaaSystTot']
...
leg = TLegend(0.18, 0.58, 0.42, 0.8) #(0.48, 0.52, 0.82, 0.75)
leg.SetFillStyle(0)
leg.SetBorderSize(0)
